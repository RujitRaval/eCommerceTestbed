...
define("mysql_database", default="team6", help="database name")
define("mysql_user", default="team6", help="database user")
define("mysql_password", default="6ArLGzEEH6QbLiR0g07VmFGxA8QEKA7O", help="database password")
...
class BaseHandler(tornado.web.RequestHandler):
    ...
    def get_current_user(self):
        if not self.get_cookie("webstore_cookie"):
            self.set_cookie("webstore_cookie", str(uuid.uuid4()), httponly=True)
...
class AddToCartHandler(BaseHandler):
    def post(self):
        ...
        c = self.db.cursor()
        query = "INSERT INTO cart (id, user_cookie, item, options) VALUES (0, %s, %s, %s)"
        c.execute(query, (cookie, id, product_options))
